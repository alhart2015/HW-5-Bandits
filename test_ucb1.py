...
def main():
    ...
    cumulative_regret_13, cumulative_regret_array_13, percentage_optimal_play_13, percentage_optimal_play_array_13 = test_ucb1(slots_13, bandit_13)
    ...
    print
    print 'Bandit 13 - Percentage of optimal plays: ' + str(percentage_optimal_play_13)
    print 'Bandit 13 - Cumulative Regret: ' + str(cumulative_regret_13)
    ...
    plt.plot(cumulative_regret_array_13, label='Bandit 13')
    ...
    plt.plot(percentage_optimal_play_array_13, label='Bandit 13')
